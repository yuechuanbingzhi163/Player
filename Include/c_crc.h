...
/* the CRC polynomial 0x1021 . This is used by XMODEM (almost CCITT).
...
#define DO1 crc = (crc<<8) ^ crctab[(crc>>8) ^ *buf++];
#define DO2 DO1 DO1
#define DO4 DO2 DO2
#define DO8 DO4 DO4
...
{
public:
	static unsigned short crc16(unsigned short crc, unsigned char *buf, size_t len )
	{
      while( len >= 8 )
      {
            DO8
